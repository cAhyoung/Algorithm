...
while day % day_1 != 0 or day % day_2 != 0 or day % day_3 != 0:  # 조건에 맞지 않으면 자동으로 반복문 종료
    day += 1  # while문의 조건이 맞을 때마다 +1을 해줌

print(day)  # 조건이 맞지 않은 것은 세 날짜의 최소공배수를 찾은 것으로 반복문이 종료된 후 day 출력
